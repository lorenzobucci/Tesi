...
import io.github.lorenzobucci.tesi.mobile_device.service.gRPC.MobileDeviceContract;
...
public class E2ETest {
    ...
    public void testContainersAreEquallyDistributedAmongTwoNodesWithSampleAllocatorAlgorithmWhenTaskOptimizationIsRequired() {
        ...
        resourcesManagementClient.getCrudBlockingStub().setAllocatorAlgorithm(StringValue.of("io.github.lorenzobucci.tesi.resources_management.allocator.SampleAllocatorAlgorithm"));
